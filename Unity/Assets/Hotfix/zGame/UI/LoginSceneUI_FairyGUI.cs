...
namespace ETHotfix
{
    ...
    {
        //登录按钮
        public const string BTN_LOGIN = "n1";
        //版本文本
        public const string TEXT_VERTION = "Ver";

        string openId = "test0329";
        ...
        public override void InitUI()
        {
            ...
            //检查版本/更新操作。。
            gcmp.GetChild(TEXT_VERTION).asTextField.text = "2019.0329V_1";
        ...
        private void OneBtnClick()
        {
            ...
            Log.Debug($"input: {openId} || {userName}");
